...
public class RoverRuckusTeleOpMarkII extends OpMode {
    ...
    @Override
    public void init() {
        RFM = hardwareMap.dcMotor.get("RFM"); //gets right front motor on hardware map
        RBM = hardwareMap.dcMotor.get("RBM"); //gets right back motor on hardware map
        LFM = hardwareMap.dcMotor.get("LFM"); //gets left front motor on hardware map
        LBM = hardwareMap.dcMotor.get("LBM"); //gets left back motor on hardware map
